...
TASK_CUSTOM_LISTS = {
    "relation_satisfaction_on_top_pepper_shaker_countertop": {
    ...
    "relation_satisfaction_under_tray_bowl": {
    ...
    "relation_satisfaction_inside_toothbrush_beaker": {
        "room_types": ["bathroom"],
        "Beechwood_0_garden": {
            "whitelist": {
                "toothbrush.n.01": {
...
def main(random_selection=False, headless=False, short_exec=False):
    ...
    default_scene_fpath = os.path.join(
        get_dataset_path("behavior-1k-assets"), "scenes", args.scene_model, "json", f"{args.scene_model}_best.json" # TODO: check if best is okay
    )
    ...
    env.task_config["use_presampled_robot_pose"] = False
